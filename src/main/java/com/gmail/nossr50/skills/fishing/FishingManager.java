...
public class FishingManager extends SkillManager {
	...
	public boolean exploitPrevention() {
		...
		Block targetBlock = getPlayer().getTargetBlock((Set) BlockUtils.getTransparentBlocks(), 100);
	...
	private FishingTreasure getFishingTreasure() {
		...
		diceRoll -= getPlayer().getInventory().getItemInHand().getEnchantmentLevel(Enchantment.LUCK);
