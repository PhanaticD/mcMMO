...
public class UnarmedManager extends SkillManager {
    ...
    public boolean canDisarm(LivingEntity target) {
        return target instanceof Player && ((Player) target).getInventory().getItemInHand().getType() != Material.AIR && Permissions.secondaryAbilityEnabled(getPlayer(), SecondaryAbility.DISARM);
    }

    public boolean canDeflect() {
        Player player = getPlayer();

        return ItemUtils.isUnarmed(player.getInventory().getItemInHand()) && Permissions.secondaryAbilityEnabled(getPlayer(), SecondaryAbility.DEFLECT);
    }
    ...
    public void disarmCheck(Player defender) {
        if (SkillUtils.activationSuccessful(SecondaryAbility.DISARM, getPlayer(), getSkillLevel(), activationChance) && !hasIronGrip(defender)) {
            ...
            Item item = Misc.dropItem(defender.getLocation(), defender.getInventory().getItemInHand());
            ...
            defender.getInventory().setItemInHand(new ItemStack(Material.AIR));
